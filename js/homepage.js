...
// Populating the page with photos and summaries of all the parks
...
var addBeenBtns = document.getElementsByClassName("addBeen");
addBeenBtns.addEventListener('click', addToBeen);
